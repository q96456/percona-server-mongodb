...
private:
    ...
    struct CollectionRoutingInfoEntry {
        ...
        std::shared_ptr<ChunkManagerWithLock> routingInfo;
    };
...
public:
     ...
     */
    std::shared_ptr<ChunkManagerWithLock> cm() const {
        return _cm;
    }
...
private:
    ...
    CachedCollectionRoutingInfo(ShardId primaryId, std::shared_ptr<ChunkManagerWithLock> cm);
    ...
    std::shared_ptr<ChunkManagerWithLock> _cm;
