 ...
 *     { foo : <anything> } => false
 */
bool isExactIdQuery(OperationContext* opCtx, const CanonicalQuery& query, ChunkManagerWithLock* manager) {
 ...
 */
bool isMetadataDifferent(const std::shared_ptr<ChunkManagerWithLock>& managerA,
                         const std::shared_ptr<Shard>& primaryA,
                         const std::shared_ptr<ChunkManagerWithLock>& managerB,
...
* of the metadata.
*/
bool wasMetadataRefreshed(const std::shared_ptr<ChunkManagerWithLock>& managerA,
                          const std::shared_ptr<Shard>& primaryA,
                          const std::shared_ptr<ChunkManagerWithLock>& managerB,
                          const std::shared_ptr<Shard>& primaryB) {
