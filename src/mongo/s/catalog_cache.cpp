...
std::shared_ptr<ChunkManagerWithLock> refreshCollectionRoutingInfo(
    OperationContext* opCtx,
    const NamespaceString& nss,
    std::shared_ptr<ChunkManagerWithLock> existingRoutingInfo,
    ...
    auto chunkManager = [&] {
        ...
        return ChunkManagerWithLock::makeNew(nss,
...
void CatalogCache::_scheduleCollectionRefresh_inlock(
    ...
    const auto onRefreshCompleted =
        [this, t, nss, isIncremental](const Status& status, ChunkManagerWithLock* routingInfoAfterRefresh) {
            if (isIncremental) {
    ...
    const auto refreshCallback =
        ...
        std::shared_ptr<ChunkManagerWithLock> newRoutingInfo;
        try {
...
CachedCollectionRoutingInfo::CachedCollectionRoutingInfo(ShardId primaryId,
                                                         std::shared_ptr<ChunkManagerWithLock> cm)
